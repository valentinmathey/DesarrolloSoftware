...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            /* Descomentar y comentar el resto para pedir la factura de la base de datos y cambiarle el numero
            Factura fac1 = entityManager.find(Factura.class, 1L);
            fac1.setNumero(74);
            entityManager.merge(fac1);
            */

            /* Descomentar y comentar el resto para borrar la factura de la base de datos
            Factura fac1 = entityManager.find(Factura.class, 1L);
